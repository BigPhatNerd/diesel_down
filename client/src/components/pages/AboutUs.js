            ...
            <Container className="pt-3">
                ...
                <Row className="m-3 text-left">
                    <p style={{ lineHeight: "1.8", fontSize: "1.1rem" }}>
                        I’ve always had an affinity for power, speed, and noise. I drove a 1998 Dodge Ram 3500 dually for 15 years and was endlessly fascinated by its power and output. In 2007, I tuned my first dieseland was blown away by the transformation in power and responsiveness. It was a thrill to see how much of a difference tuning a diesel engine could make.
                    </p>
                    <p style={{ lineHeight: "1.8", fontSize: "1.1rem" }}>
                    ...
                    <p style={{ lineHeight: "1.8", fontSize: "1.1rem" }}>
                        Over the years, I continued to add modifications and tunes to various diesel trucks- a Ford F-350, F-250 and a Chevy Duramax 2500, but I always favored the Dodge diesel. Recently, I found an old 2000 Dodge Ram 2500 5.9L 24valve Cummins, and I knew I had to have it.
                    </p>
                    <p style={{ lineHeight: "1.8", fontSize: "1.1rem" }}>
                ...
                <Row className="justify-content-center m-2">
                    <p style={styles.italicText}>
                        Want to learn more? <br />Call or Text Us at (901) 921-3757
                    </p>
                </Row>
